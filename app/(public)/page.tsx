  ...
  return (
    <main className="-mx-6 -mt-10">
      ...
      <section className="relative isolate left-1/2 right-1/2 w-screen -translate-x-1/2 overflow-hidden bg-[#030405]">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(3,4,5,0.18)_0%,rgba(3,4,5,0.28)_10%,rgba(3,4,5,0.58)_24%,rgba(3,4,5,0.82)_50%,rgba(3,4,5,0.94)_76%,rgba(3,4,5,0.99)_100%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(214,171,92,0.16),transparent_20%),radial-gradient(circle_at_18%_34%,rgba(0,0,0,0.78),transparent_34%),radial-gradient(circle_at_78%_28%,rgba(0,0,0,0.54),transparent_30%),radial-gradient(circle_at_100%_32%,rgba(0,0,0,0.42),transparent_32%),radial-gradient(circle_at_center,transparent_18%,rgba(0,0,0,0.18)_48%,rgba(0,0,0,0.7)_100%)]" />
        ...
        <div className="absolute inset-y-0 left-0 w-full bg-[linear-gradient(90deg,rgba(0,0,0,0.9)_0%,rgba(0,0,0,0.8)_14%,rgba(0,0,0,0.54)_32%,rgba(0,0,0,0.24)_52%,rgba(0,0,0,0.18)_72%,rgba(0,0,0,0.26)_100%)] md:w-[74%]" />
        <div className="absolute inset-y-0 left-0 w-full bg-[radial-gradient(circle_at_44%_34%,rgba(0,0,0,0.08),rgba(0,0,0,0.84)_100%)] md:hidden" />
        <div className="relative mx-auto flex min-h-[33rem] max-w-7xl items-end px-6 pb-12 pt-24 md:min-h-[42rem] md:items-center md:pb-20 md:pt-20">
          <div className="relative w-full max-w-4xl">
            <div className="absolute inset-0 rounded-[30px] bg-[radial-gradient(circle_at_top_left,rgba(196,152,79,0.14),transparent_24%),linear-gradient(135deg,rgba(2,2,2,0.56),rgba(2,2,2,0.36)_44%,rgba(2,2,2,0.08)_100%)] opacity-100 backdrop-blur-[12px]" />
            <div className="relative flex max-w-4xl flex-col items-center space-y-6 rounded-[30px] px-5 py-7 text-center shadow-[0_24px_80px_rgba(0,0,0,0.34)] md:max-w-[44rem] md:items-start md:px-8 md:py-10 md:text-left">
              ...
              <p className="max-w-3xl text-lg leading-8 text-white/94 md:text-[1.15rem]">
