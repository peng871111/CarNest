...
function serializeWarehouseIntakeDoc(id: string, data: Record<string, unknown>): WarehouseIntakeRecord {
  ...
  return {
    ...
    vehicleReportGeneratedAt: serializeDate(data.vehicleReportGeneratedAt),
    pdfRegenerationRequiredAt: serializeDate(data.pdfRegenerationRequiredAt),
    pdfRegenerationReason: typeof data.pdfRegenerationReason === "string" ? data.pdfRegenerationReason : "",
    pdfRegenerationRequiredByUid: typeof data.pdfRegenerationRequiredByUid === "string" ? data.pdfRegenerationRequiredByUid : "",
    pdfRegenerationRequiredByName: typeof data.pdfRegenerationRequiredByName === "string" ? data.pdfRegenerationRequiredByName : "",
...
function buildWarehouseIntakeWritePayload(
  ...
  return {
    ...
    pdfRegenerationRequiredAt: input.pdfRegenerationRequiredAt || "",
    pdfRegenerationReason: input.pdfRegenerationReason || "",
    pdfRegenerationRequiredByUid: input.pdfRegenerationRequiredByUid || "",
    pdfRegenerationRequiredByName: input.pdfRegenerationRequiredByName || "",
